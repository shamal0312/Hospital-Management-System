...
<head>
  ...
  <title>HospitaLink | Medical Reports</title>
  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
        ...
        <a href="${pageContext.request.contextPath}/report?action=create" class="flex items-center gap-2 px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition">
                ...
                <c:forEach var="report" items="${reports}">
                  <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td class="px-6 py-4 text-center space-x-3">
                      <a href="${pageContext.request.contextPath}/report?action=edit&id=${report.reportId}" class="text-green-500 hover:text-green-600">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/report?action=delete&id=${report.reportId}" onclick="return confirmDelete(this.href);" class="text-red-500 hover:text-red-600">
