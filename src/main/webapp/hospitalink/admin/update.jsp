...
<head>
  ...
  <title>HospitaLink | Edit Admin</title>
      ...
      <form action="${pageContext.request.contextPath}/admin" method="POST" class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium mb-1" for="password">Password <span class="text-xs text-gray-400">(Leave blank to keep existing)</span></label>
        ...
        <div class="mt-8 flex justify-end">
          <button id="submitButton" type="submit" class="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition">
  ...
  <script>
    function validatePassword() {
      ...
      if (password.length > 0) {
        ...
        // No password entered -> allow submit
    ...
    // On page load, always allow submit (if password is empty)
